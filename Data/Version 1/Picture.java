...
public class Picture{
    ...
    public int[][] get_picture_color(int i_col_count_led, int i_row_count_led, int segment_size){
        ...
        //segmentbreite 100%
        i_segment_width_distance = i_width / i_col_count_led;
        ...
        //i_segment_width = i_segment_width/2;
        //i_segment_width = (int)(Math.round( (double)i_width / (double)i_col_count_led));
        //System.out.println(i_segment_width+" = "+i_width+" / "+i_col_count_led);
        //i_segment_height = (int)(Math.round( (double)i_height / (double)i_row_count_led));
        //segmenthöhe 100%
        i_segment_height_distance = i_height / i_row_count_led;
        ...
        //System.out.println(i_segment_height+" = "+i_height+" / "+i_row_count_led);
        //i_segment_height = i_segment_height/2;
